...
void Room2::Initialize(Entity *player){
    // Map
    static unsigned int levelData[] =
    {
        16,  16,  16,  16,  16,  16,  16,  16,  16,  16,  16,  16,  16,  16,  16,  16,
        16,   4,  31,  31,  31,  31,  31,  31,  31,  31,  31,  31,  31,  31,   5,  16,
        16,  17,  60,  60,  60, 135,  60,  60,  60,  60, 135,  60,  60,  60,  15,  16,
        16,  17,  64,  79,  16,  64,  64,  79,  64,  79,  65,  16,  79,  79,  15,  16,
        16,  17,  79,  79,  16,  64,  64,  65,  79,  79,  80,  16,  79,  65,  15,  16,
        16,  17,  64,  65,  16,  79,  79,  80,  64,  80,  79,  16,  79,  80,  15,  16,
        16,  17,  64,  80,  16,  79,  64,  64,  79,  64,  79,  16,  79,  79,  15,  16,
        16,  17,  64,  79,  16,  64,  64,  79,  64,  79,  65,  16,  79,  65,  15,  16,
        16,  17,  79,  79,  16,  64,  64,  65,  79,  79,  80,  16,  79,  80,  15,  16,
        16,  17,  64,  79,  16,  79,  79,  80,  64,  80,  79,  16,  79,  79,  15,  16,
    ...
    state.Enemy[0].position = vec3(6.0f, -3.0f, 0);
    state.Enemy[1].position = vec3(8.0f, -3.5f, 0);
    ...
    state.Enemy[2].position = vec3(3.0f, -4.0f, 0);
    state.Enemy[3].position = vec3(3.0f, -7.0f, 0);
    state.Enemy[4].position = vec3(12.0f, -5.0f, 0);
...
void Room2::Update(float &lastTick, float deltaTime, float animStep, float &animTime){
    // General Updates
        // Player Shots
...
void Room2::Render(ShaderProgram *program, GLuint fontTex, GLuint HPTex, bool &gameWon, bool &gameLost){
    // Rendering Map
